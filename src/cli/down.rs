use super::{
    ...
    FILE_OPTION, HELP_OPTION, VERSION_OPTION,
};
use crate::Result;
use lexopt::Parser;
...
pub(crate) static SPEC: CommandSpec = CommandSpec {
    name: "down",
    about: "Stop and delete the exact machines recorded for this world.",
    options: &[FILE_OPTION],
    positionals: &[],
    examples: &["smolworld down", "smolworld down --file ./world.smolworld"],
    subcommands: &[],
};
